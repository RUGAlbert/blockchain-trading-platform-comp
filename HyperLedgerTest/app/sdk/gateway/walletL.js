...
//const CRYPTO_CONFIG_PEER_ORGS = '/vagrant/network/caserver/client'
const CRYPTO_CONFIG_PEER_ORGS = path.resolve(__dirname, '../../../network/caserver/client');
...
function readCertCryptogen(org, user) {
    ...
    var certPath = CRYPTO_CONFIG_PEER_ORGS + "/" + org + "/" + user + "/msp/signcerts/cert.pem"
...
function readPrivateKeyCryptogen(org, user) {
    ...
    var pkFolder = CRYPTO_CONFIG_PEER_ORGS+ "/" + org + "/" + user + "/msp/keystore"
