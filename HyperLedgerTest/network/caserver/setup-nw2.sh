...
echo    '========= Joining the test-peer1 to Airline channel ============'
peer channel fetch config $AIRLINE_CHANNEL_BLOCK -o $ORDERER_ADDRESS -c airlinechannel
export CORE_PEER_LOCALMSPID=TestMSP
ORG_NAME=test.com
export CORE_PEER_ADDRESS=test-peer1.test.com:9051
export CORE_PEER_MSPCONFIGPATH=$PWD/client/test/admin/msp
peer channel join -o $ORDERER_ADDRESS -b $AIRLINE_CHANNEL_BLOCK
# Update anchor peer on channel for test
sleep  $SLEEP_TIME
